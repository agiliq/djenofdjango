...
and customize the forms for post and comment models. By convetion, all custom forms should be in <app>/forms.py
...
Here we are handling GET and POST in the same view. If this is a GET request, the form would be empty else it would be fileed
